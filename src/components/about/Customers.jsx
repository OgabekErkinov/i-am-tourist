  ...
  return (
    <Box width="90%" height="auto" mx="auto" my="4rem">
      <Stack justifyContent="center" alignItems="center">
        <Typography variant="h4" data-aos = 'fade-up' fontFamily="Poppins" 
                    fontWeight={700} mb="2rem" color={textColor} textAlign='center'>
          {t("CustomersSaid")}
        </Typography>
        <Box width="100%" height='14rem'>
          ...
          >
            {customers?.map((quote, idx) => (
              <SwiperSlide key={idx}>
                <Stack data-aos = 'fade-up' bgcolor="white" height="100%" width="100%" justifyContent='space-between'
                       padding="1rem" borderRadius="0.5rem" boxShadow="0px 4px 10px rgba(0, 0, 0, 0.1)">
                  <Typography textAlign="start" fontFamily="Poppins" color="gray" fontSize={smScreen ? '12px' : '14px'}>
                    {quote.quote}
                  </Typography>
